...
<nav class="nav-containner" >
    ...
    <div id="page-wrapper" class="page-wrapper">
        <div class="container-home">
            <p class="breadcrumb"><i></i>用户修改</p>
            <div class="form-wrapper">
                <form method="post" class="form-box" id="form-add">
                    <input type="hidden" name="admin_id" value="<?php echo ($user["admin_id"]); ?>">
                    <div>
                        <label for="formTextUsername" class="form-label">用户名:</label>
                        <input type="text" value="<?php echo ($user["username"]); ?>" name="username" class="form-text" placeholder="请填写用户名" id="formTextUsername" readonly>
                    </div>
                    <div>
                        <label for="formTextRealname" class="form-label">真实姓名:</label>
                        <input type="text" value="<?php echo ($user["realname"]); ?>" name="realname" class="form-text" placeholder="请填写真实姓名" id="formTextRealname">
                    </div>
                    <div>
                        <label for="formTextEmail" class="form-label">邮箱:</label>
                        <input type="email" value="<?php echo ($user["email"]); ?>" name="email" class="form-text" placeholder="请填写邮箱" id="formTextEmail">
                    </div>
                    <div>
...
<script type="text/javascript">
    var SCOPE = {
        'save_url' : "/imoocnews/admin/admin/add",
