            ...
            <div class="form-wrapper">
                <form method="post" class="form-box" id="form-add">
                    <div>
                        ...
                        <input type="text" name="title" class="form-text" placeholder="请填写文章标题" id="formTextTitle">
                    </div>
                    <div>
                        <label for="formTextSmallTitle" class="form-label">短标题:</label>
                        <input type="text" name="small_title" class="form-text" placeholder="请填写文章短标题" id="formTextSmallTitle">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div class="thumb_box" style="display:inline-block;vertical-align:top;width:50%;min-width:400px;">
                            ...
                            <input id="file_upload_video" class="form-text" name="video" type="text" multiple="true" value="" placeholder="视频URL地址">
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="description" class="form-text" placeholder="描述" id="formTextDescription">
                    </div>
                    <div>
                        <label for="formTextKeywords" class="form-label">关键字:</label>
                        <input type="text" name="keywords" class="form-text" placeholder="关键字" id="formTextKeywords">
                    </div>
                    <div>
